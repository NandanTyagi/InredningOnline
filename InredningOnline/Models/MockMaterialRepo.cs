        ...
        public IEnumerable<Material> AllMaterials
        {
            get
            {
                return new List<Material>
                {
                    ...
                    new Material {Id = 4, ProjectId = 2, Name = "Chair4", Amount = 1, Price = 82, Details = "N/A"},
                    ...
                    new Material {Id = 7, ProjectId = 1,Name = "Chair7", Amount = 1, Price = 80, Details = "N/A"},
                    new Material {Id = 8, ProjectId = 2,Name = "Chair8", Amount = 1, Price = 66, Details = "N/A"},
                    new Material {Id = 9, ProjectId = 2,Name = "Chair9", Amount = 10, Price = 22, Details = "N/A"},
                    new Material {Id = 10, ProjectId = 2,Name = "Chair10", Amount = 12, Price = 24, Details = "N/A"}
                };
            }
        }
